  ...
  return (
    <section className="relative flex flex-col pt-28 md:pt-40 h-screen min-h-[850px] overflow-visible items-center bg-[#F8F9FB]">
      <div className="flex flex-1 justify-center items-center mx-auto pb-[12vh] w-[85%] md:w-9/12 max-w-[1440px] overflow-visible relative">
        ...
        <div className="absolute top-[-80%] md:top-[-165%] left-1/2 -translate-x-1/2 w-[160%] md:w-[220%] max-w-none h-auto scale-x-200 scale-y-170 pointer-events-none z-0">
          <img 
            src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/8cf50684-2b66-43f2-a0ba-6a955350d998-sarvam-ai/assets/svgs/hero-gradient-2.svg" 
            alt="" 
        ...
        <div className="z-10 relative flex flex-col items-center gap-5 md:gap-10">
          ...
          <div className="w-auto h-10 flex items-center justify-center">
            <img 
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/8cf50684-2b66-43f2-a0ba-6a955350d998-sarvam-ai/assets/svgs/motif-3.svg" 
              alt="" 
              role="presentation" 
          ...
          {/* Shimmer Badge */}
          <div className="relative bg-white/50 shadow-[0px_0px_60px_0px_rgba(85,106,220,0.12)] backdrop-blur-lg px-5 py-2.5 border border-[#556ADC]/20 rounded-full overflow-hidden group">
            <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/60 to-transparent -translate-x-full animate-shimmer pointer-events-none" style={{ animationDuration: '3s' }}></span>
          ...
          <div className="mt-2 md:mt-4">
            <a href="https://dashboard.sarvam.ai/signin" aria-label="Sign in to experience Sarvam">
      ...
      <div className="absolute bottom-8 md:bottom-14 flex flex-col items-center gap-8 w-full shrink-0 z-10">
