...
const DeploymentOptions = () => {
  const options = [
    {
      title: "Web Interface",
      description: "Upload your program folder or paste code directly. Get a full visual report in your browser.",
    ...
    {
      title: "REST API",
      description: "POST /api/analyze with your .rs files. Get back a structured AnalysisReport in JSON.",
    ...
    {
      title: "Local Binary",
      description: "Run chainprobe directly on your machine. No data leaves your system. Full offline analysis.",
      ...
      <div className="container mx-auto px-[7.5%] max-w-[1440px]">
        ...
        <div className="flex flex-col items-center text-center mb-16 md:mb-20">
          <h2 className="font-serif text-[32px] md:text-[36px] text-foreground leading-[1.35] max-w-2xl px-4">
            Run analysis<br className="md:hidden" /> wherever you build
          </h2>
        </div>
